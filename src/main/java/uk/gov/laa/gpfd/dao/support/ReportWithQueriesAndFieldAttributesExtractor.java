    ...
    public Collection<Report> extractData(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            var report = reportMap.computeIfAbsent(reportId, id -> {
                try {
                    ...
                    return Report.builder()
                            ...
                            .reportCreatorName(rs.getString("REPORT_CREATOR_NAME"))
                            .reportCreatorEmail(rs.getString("REPORT_CREATOR_EMAIL"))
                            ...
                            .description(rs.getString("DESCRIPTION"))
                            .reportOutputType(ReportOutputType.builder()
            ...
            if (fieldAttributeId != null) {
                ...
                var fieldAttribute = FieldAttributes.builder()
