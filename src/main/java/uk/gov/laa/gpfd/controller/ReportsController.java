...
public class ReportsController implements ReportsApi {
     ...
     */
    @Async
    @RequestMapping(value = "/excel/{id}", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
    DeferredResult<StreamingResponseBody> getExcel(HttpServletResponse response, @PathVariable(value = "id") UUID requestedId) {
